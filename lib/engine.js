...
(function (root, factory) {
  ...
  function prevSessionClose(snap, todayET) {
    if (!snap) return null;
    var dayIsToday = snap.dailyBar && etDateStr(snap.dailyBar.t) === todayET;
    if (dayIsToday) return snap.prevDailyBar ? num(snap.prevDailyBar.c) : null;
  ...
  return {
    ...
    rank: rank, rowEligible: rowEligible, prevSessionClose: prevSessionClose, rankScore: rankScore, rankTier: rankTier,
